...
var _ArrowExpression = require('./../syntax/arrow-expression.js');

var _ArrowExpression2 = _interopRequireDefault(_ArrowExpression);
...
function callBackToArrow(node, parent) {
  ...
  if (node.type === 'FunctionExpression' && parent.type === 'CallExpression' && !hasThis(node)) {
    var arrow = new _ArrowExpression2['default']();
...
function hasThis(node) {
  ...
  if (_import2['default'].isArray(node)) {
